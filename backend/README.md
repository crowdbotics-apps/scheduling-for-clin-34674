...
## Project Structure
    ...
    ├── scheduling_for_clin_34674  # Django project configurations
...
1. Clone this repo and `cd scheduling_for_clin_34674`
...
2. Clone this repo and `cd scheduling_for_clin_34674`
